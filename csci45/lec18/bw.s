...
loop:
  ...
  add v4.8H, v4.8H, v5.8H
  add v4.8H, v4.8H, v5.8H // now every chunk of v4 holds 384

  cmge v0.8H, v3.8H, v4.8H // compare r+g+b with the threshold value

  // shrink v0 down into 8 bits again
  xtn v3.8B, v0.8H // we just shrunk v0 down into *the right half* of v3

  mov v0.8B, v3.8B // right half ov v0 holds blue
  mov v1.8B, v3.8B // right half ov v1 holds green
  mov v2.8B, v3.8B // right half ov v2 holds red
