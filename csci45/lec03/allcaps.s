...
_start:
  ...
  ldr x0, =csci // addr of the csci string = addr of its first char

  // capitalize the first char
  ldrb w1, [x0] // x0 holds the addr of the 'c'
  // w1 is the right 32 bits of x1 (ldrb can only handle W registers)
  ...
  ldr x1, =csci // add of string goes in x1
