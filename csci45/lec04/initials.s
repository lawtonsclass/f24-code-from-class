...
_start:
  ...
  // let's add dots to the intitials by moving each char of the
  // initials to the initials_with_dots string

  // first addr to write to is &initials_with_dots
  ldr x0, =initials_with_dots
  // first addr to read from is &initials
  ldr x1, =initials
  ldrb w2, [x1] // w2 = *x1 (first char is now in w2) 
